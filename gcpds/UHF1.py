...
class UHF1():
    def __init__(self, sample_rate: int = 20):
        """
        Initialize the UHF1 object with the given parameters and create additional objects for further analysis.
        ...
        frequencies (list): List of channels frequencies in range 400MHz to 470MHz.
    ...
    def parameter(self, data: np.ndarray, nper: int = 32768, fc: float = 435e6, gps: np.ndarray = None) -> dict:
        """Calculate parameters in Fixed and Movil service (400MHz to 470MHz)
