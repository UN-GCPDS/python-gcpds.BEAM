...
class VHF2():
    def __init__(self, sample_rate: int = 14e6): # Definir el sample rate
        """
    ...
    def parameter(self, data: np.ndarray, fc: float = 435e6) -> dict: # Definir cual debe ser la frecuencia central
